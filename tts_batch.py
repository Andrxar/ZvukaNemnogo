...
FREETTS_AUDIO_EXT = os.environ.get("FREETTS_AUDIO_EXT", "mp3")
FREETTS_POLL_ATTEMPTS = int(os.environ.get("FREETTS_POLL_ATTEMPTS", "30"))
FREETTS_POLL_DELAY = int(os.environ.get("FREETTS_POLL_DELAY_SEC", "2"))
FREETTS_REQUEST_DELAY = int(os.environ.get("FREETTS_REQUEST_DELAY_SEC", "3"))
FREETTS_TOKEN = os.environ.get("FREETTS_TOKEN")
FREETTS_VOICE_ID = os.environ.get("FREETTS_VOICE_ID")
FREETTS_LANG_CODE = os.environ.get("FREETTS_LANG_CODE")
FREETTS_FALLBACK_VOICE_ID = os.environ.get("FREETTS_FALLBACK_VOICE_ID", "VbNqRtKmLpOz")
FREETTS_FALLBACK_LANG_CODE = os.environ.get("FREETTS_FALLBACK_LANG_CODE", "ru")
FREETTS_COOKIE = os.environ.get("FREETTS_COOKIE")
